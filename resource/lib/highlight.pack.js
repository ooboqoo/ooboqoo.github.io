...
keyword:"Self",built_in:i}},{className:"punctuation",begin:"->"},n]}}})());hljs.registerLanguage("handlebars",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[w]}]}}})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
end:/$/,keywords:{$pattern:/[\.\w]+/,keyword:".PHONY"}},r]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("erlang",(()=>{"use strict";return e=>{
...
strings:i,keywords:u}}}})());hljs.registerLanguage("wasm",(()=>{"use strict";return e=>{
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("groovy",(()=>{"use strict";function e(e,n={}){
...
excludeBegin:!0,end:a+":",relevance:0}],illegal:/#|<\//};var l}})());hljs.registerLanguage("dart",(()=>{"use strict";return e=>{const n={
...
},e.C_NUMBER_MODE,{className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("gradle",(()=>{"use strict";return e=>({name:"Gradle",
case_insensitive:!0,
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},n,r]}}})());hljs.registerLanguage("scss",(()=>{"use strict"
...
type:[...t,"set","list","map"]},end:">",contains:["self"]}]}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
name:"Scheme",illegal:/\S/,contains:[e.SHEBANG(),a,i,l,g,d].concat(c)}}})());hljs.registerLanguage("nginx",(()=>{"use strict";function e(e){
return n("(?=",e,")")}function n(...e){return e.map((e=>{
return(n=e)?"string"==typeof n?n:n.source:null;var n})).join("")}return a=>{
...
end:/$/}]})})());hljs.registerLanguage("properties",(()=>{"use strict";return e=>{
